    ...
    <div class="content-wrapper">
        ...
        <section class="content-header"> 
         <ol class="breadcrumb left">
           ...
           <li class="active">Tambah crowdfunding</li>
         </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="card card-red">
                        <div class="card-header with-border">
                            <h3 class="card-title">Tambah crowdfunding</h3>
                        </div><!-- /.card-header -->
                        <form class="" action="<?php echo site_url('admin/kelola_crowdfunding/tambah/');?>" method="post">
                        <div class="card-body">
                          <div class="row">
                            <div class="col-md-5">
                              ...
                              <div class="form-group <?php echo (form_error('need')) ? 'has-error' : '';?>">
                                ...
                                <input class="form-control" type="text" name="need" value="<?php echo set_value('need'); ?>">
