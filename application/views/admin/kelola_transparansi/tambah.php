    ...
    <div class="content-wrapper">
        ...
        <section class="content-header"> 
         <ol class="breadcrumb left">
           ...
           <li class="active">Tambah transparansi</li>
         </ol>
        </section>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-red">
                        ...
                        <form class="" action="<?php echo site_url('admin/kelola_transparansi/tambah/');?>" method="post" enctype="multipart/form-data">
                        <div class="card-body">
                          <div class="row">
                            <div class="col-md-5">
                              ...
                              <div class="form-group <?php echo (form_error('short_desc')) ? 'has-error' : '';?>">
                                ...
                                <textarea class="form-control"  name="short_desc" ><?php echo set_value('short_desc'); ?></textarea> 
                            ...
                            <div class="col-md-5 offset-md-1"> 
                              <div class="form-group <?php echo (form_error('thumbnail')) ? 'has-error' : '';?>">
                                <label for="inputNama" class="control-label">Thumbnail</label> 
